...
const Login: React.FC = () => {
  ...
  if (isMobile) {
    return (
      <div className="min-h-screen bg-white flex justify-between p-2">
        <div className="w-full max-w-md overflow-hidden">
          {/* Header with logo */}
          <div className="px-2 pt-1 pb-2 flex mb-10 justify-between items-end w-full rtl">
            <img src={image} width={120} height={50} alt="" />
          </div>

          <form onSubmit={handleSubmit(onSubmit)} className="px-4 pt-1 pb-4">
            {/* Main heading */}
            <h1 className="text-xl font-bold mb-1 mt-2 text-right">تسجيل الدخول</h1>
            <p className="text-sm text-[#00000099] text-[14px] mb-15 text-right">سجل دخولك للوصول إلى حسابك والاستفادة من خدمات المنصة</p>
            ...
            <div className="mb-2 mt-6">
              ...
              <input
                type="email"
                className="w-full p-2 bg-[#F7F7F7] rounded-lg text-right"
            ...
            <button
              type="submit"
              className="w-full bg-[#004136] text-white mt-10 py-2 rounded-lg font-medium hover:bg-green-900 transition duration-200"
            >
              تسجيل الدخول
            </button>
            ...
            <button
              type="button"
              className="w-full flex justify-center items-center bg-[#F7F7F7] py-2 rounded-lg font-medium text-gray-700 hover:bg-gray-50 transition duration-200 rtl"
            >
            ...
            <div className="text-center mt-4">
              ...
              <Link to="/" className="text-green-800 text-sm font-medium">
                إنشاء حساب
              </Link>
            </div>
          </form>
    ...
    <div className="flex h-screen bg-[#F5F5F5] font-sans">
      ...
      <div className="w-1/2 flex flex-col pr-16 items-end justify-center text-right bg-white">
        <div className="relative w-8/10 z-10 justify-end">
          <div className="mb-8">
            <img src={logo} alt="Logo" className="w-32 h-auto mb-12 ml-auto" />
            <h1 className="text-3xl font-bold mb-2 text-[#004136]">
              تسجيل الدخول
            </h1>
            <p className="text-sm mb-16 text-gray-600">
              سجل دخولك للوصول إلى حسابك والاستفادة من خدمات المنصة
            </p>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="mb-4">
                ...
                <input
                  type="email"
                  className="w-full p-3 h-10 bg-[#F5F5F5] rounded-lg text-right"
                  placeholder="أدخل البريد الإلكتروني هنا"
                  {...register("email", {
                    required: "البريد الإلكتروني مطلوب",
                    pattern: {
              ...
              <div className="mb-4">
                ...
                <div className="flex justify-end mt-2 mb-16">
              ...
              <button
                type="submit"
                className="w-full text-white text-center mt-6 h-10  rounded-[15px] bg-[#004136] hover:bg-[#003028] transition-colors"
              >
                تسجيل الدخول
              </button>
            </form>
            <div className="text-right mt-4">
              ...
              <button
                className="mt-2 h-10 flex items-center justify-center w-full p-3 rounded-[15px] bg-[#B4B7BD1A] text-[#004136] hover:bg-[#B4B7BD33] transition-colors rtl"
              >
                تسجيل عن طريق Google
              ...
              <p className="text-sm text-gray-600 mt-4 text-center">
                ليس لديك حساب؟{" "}
                <Link to="/" className="text-[#004136] font-[600] text-[#004136] hover:underline font-IBM_Plex_Sans_Arabic">
                  إنشاء حساب
                </Link>
              </p>
            </div>
